...
Table1Primary <- data.lvl0.df$data$Table1$primary |>
  ...
  mutate(of_variable = case_when(
         ...
         column_name == "C (g m<sup>-2</sup>)" ~ "soil_carbon",
         column_name == "N (g m<sup>-2</sup>)" ~ "soil_nitrogen",
         column_name == "pH<sub>CaCl2</sub>" ~ "soil_ph")) |>
  mutate(source = 'Table 1')

###Hitting errors with stuff below (function called RHS); tried to install formula.tools packages but that didn't work.
Table1Meta <- Table1Primary |>
  ...
  tribble(~of_variable, ~method, ~source,
          'soil_ph', paste0(data.lev0.ls$method[25:26], collapse = ' '), 'Methods ln25-26',
          'soil_carbon', paste0(data.lev0.ls$method[29:30], collapse = ' '), 'Methods ln29-30',
          'soil_nitrogen', paste0(data.lev0.ls$method[29:30], collapse = ' '), 'Methods ln29-30',
          'soil_depth', paste0(data.lev0.ls$method[20], collapse = ' '), 'Methods ln20',
 ) ) |>
