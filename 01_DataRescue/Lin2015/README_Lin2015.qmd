...
+ Lead
  ...
  - [ ] Create a fresh fork of the primary repository https://github.com/ktoddbrown/SoilDRaH/tree/main, it might be useful to rename it 'SoilDRaH_Lin2015'
  - [ ] Create a copy of this template folder and rename it to Lin2015
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Lin2015_Methods_ABC.md Lin2015_Methods_BCD.md
```
